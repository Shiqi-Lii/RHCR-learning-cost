...
def _run_one(task: dict) -> list:
    ...
    return [sim_w, plan_w, k, seed, status, returncode, completed, throughput, str(run_dir)]
...
def main():
    ...
    (run_root / "run_config_snapshot.json").write_text(json.dumps(cfg, indent=2), encoding="utf-8")
